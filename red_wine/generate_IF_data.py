...
from GAN_vfl_gumbel_mp import DiscriminatorClient_1 as D_C1_vfl
from GAN_vfl_gumbel_mp import DiscriminatorClient_2 as D_C2_vfl
...
def main(param_path, data_path, size=1599, delet_target=None):
