...
parser.add_argument("--n_steps", type=int, default=150, help="number of steps of epoch")
...
parser.add_argument("--sigma", type=float, default=2.253, help="interval betwen image samples")
...
#         param_path = "params/DP_WGAN_vfl_shadow/" + str(seed) + '/'
#         fid_min += [train(seed=seed, param_path=param_path)]
#
#     f = open("params/DP_WGAN_vfl_shadow/fid_min.txt", "w")
#     f.write(str(fid_min))
#     f.close()
...
if __name__ == '__main__':
    ...
    print(target if target else 'shadow')
